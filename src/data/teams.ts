...
export const TEAMS: Team[] = [
  ...
  },
  {
    ...
    division: 'PC',
    status: 'current',
    image: '/images/gabence.png',
    imageAlt: 'NIGHTRAID Gabence - Current Compe Team',
    players: [{ tag: 'GABENCE', role: 'Entry / Rifler' }],
    headline: 'BSM Asia S2 Lineup',
    note: 'Official NIGHTRAID Shadow player competing in Blood Strike Masters Asia Season 2.',
  },
  {
    id: 'harl',
    name: 'HARL',
    ...
    division: 'PC',
    status: 'current',
    image: '/images/harl.png',
    imageAlt: 'NIGHTRAID Harl - Current Compe Team',
    players: [{ tag: 'HARL', role: 'Flex / Support' }],
    headline: 'BSM Asia S2 Lineup',
    note: 'Official NIGHTRAID Shadow player competing in Blood Strike Masters Asia Season 2.',
  },
  {
    ...
    imageAlt: 'NIGHTRAID Wayne - Current Compe Team',
    players: [{ tag: 'WAYNE', role: 'IGL / Anchor' }],
    headline: 'BSM Asia S2 Lineup',
    note: 'Official NIGHTRAID Shadow player competing in Blood Strike Masters Asia Season 2.',
  },
  {
    ...
    division: 'PC',
    status: 'current',
    image: '/images/gomdi.png',
    imageAlt: 'NIGHTRAID Gomdi - Current Compe Team',
    players: [{ tag: 'GOMDI', role: 'Entry / Fragger' }],
    headline: 'BSM Asia S2 Lineup',
    note: 'Official NIGHTRAID Shadow player competing in Blood Strike Masters Asia Season 2.',
  },
  {
    ...
    division: 'PC',
    status: 'current',
    image: '/images/agony.png',
    imageAlt: 'NIGHTRAID Agony - Current Compe Team',
    players: [{ tag: 'AGONY', role: 'Sniper / Flex' }],
    headline: 'BSM Asia S2 Lineup',
    note: 'Official NIGHTRAID Shadow player competing in Blood Strike Masters Asia Season 2.',
  },
  {
    ...
    players: [
      { tag: 'GABENCE', role: 'Masters Asia S2 lineup' },
      { tag: 'HARL', role: 'Masters Asia S2 lineup' },
      { tag: 'WAYNE', role: 'Masters Asia S2 lineup' },
      { tag: 'GOMDI', role: 'Masters Asia S2 lineup' },
      { tag: 'AGONY', role: 'Masters Asia S2 lineup' },
    ],
    headline: 'BSM Asia S2 Lineup',
