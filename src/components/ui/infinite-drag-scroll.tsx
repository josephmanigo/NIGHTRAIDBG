...
export const GridItem = ({
  ...
  const gridItemStyles = cva(
    "overflow-hidden w-full h-full will-change-transform pointer-events-none select-none",
    {
      variants: {
        variant: {
          default: "rounded-sm",
          ...
          polaroid:
            "border-10 border-b-28 border-white shadow-xl even:rotate-3 odd:-rotate-2 transition-transform ease-out duration-300 even:mt-[60%]",
        },
      },
      defaultVariants: {
        variant: "default",
