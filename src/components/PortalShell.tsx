...
export default function PortalShell({
  ...
  return (
    <div className="nr-site-surface min-h-screen bg-paper text-bone">
      <header className={showHeaderDivider ? 'border-b border-bone/10' : ''}>
      ...
      <main className="mx-auto w-full max-w-[110rem] px-5 py-16 sm:px-8 sm:py-24 lg:px-12">
        {eyebrow && <p className="ln-label text-blood">{eyebrow}</p>}
        <h1 className={`${eyebrow ? 'mt-5' : ''} text-[clamp(2.8rem,7vw,6.5rem)] uppercase leading-[0.9] text-bone`}>
